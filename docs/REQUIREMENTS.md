...
9. CLI: `assistonauts expedition create --config <path>` — copies/validates expedition config into `expeditions/<name>/`, creates directory structure. `assistonauts build <expedition-name>` — runs build phase with iterative planning.
